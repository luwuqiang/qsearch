...
public class PinyinTokenFilter extends TokenFilter {  
    ...
    public PinyinTokenFilter(TokenStream input) {  
        this(input, DefaultPinYinConfig.getPinYinconfig().isDefaultFirstChar(), DefaultPinYinConfig.getPinYinconfig().getDefaultMinTermLength());  
    }  
  
    public PinyinTokenFilter(TokenStream input, boolean firstChar) {  
        this(input, firstChar, DefaultPinYinConfig.getPinYinconfig().getDefaultMinTermLength());  
    }  
  
    public PinyinTokenFilter(TokenStream input, boolean firstChar,  
            int minTermLenght) {  
        this(input, firstChar, minTermLenght, DefaultPinYinConfig.getPinYinconfig().isDefaultNgramChinese());  
    }  
    ...
    public PinyinTokenFilter(TokenStream input, boolean firstChar,  
        ...
        this.minTermLength = DefaultPinYinConfig.getPinYinconfig().getDefaultMinTermLength();  
  
        this.outChinese = DefaultPinYinConfig.getPinYinconfig().isDefaultOutChinese();  

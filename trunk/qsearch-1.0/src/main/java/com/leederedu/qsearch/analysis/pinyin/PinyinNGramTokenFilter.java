...
public class PinyinNGramTokenFilter extends TokenFilter {  
    ...
    public PinyinNGramTokenFilter(TokenStream input) {  
        this(input, DefaultPinYinConfig.getPinYinconfig().getDefaultMinGram(), DefaultPinYinConfig.getPinYinconfig().getDefaultMaxGram(), DEFAULT_NGRAM_CHINESE);  
    }  
      
    public PinyinNGramTokenFilter(TokenStream input, int maxGram) {  
        this(input, DefaultPinYinConfig.getPinYinconfig().getDefaultMinGram(), maxGram, DEFAULT_NGRAM_CHINESE);  
    }  
